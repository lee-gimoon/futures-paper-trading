...
이 프로젝트에서 WebFlux를 쓴 핵심 이유는 요청 1개당 스레드 1개가 오래 묶이는 구조를 피하고, Binance WebSocket 수신·브라우저 SSE fan-out·R2DBC DB 대기를 이벤트 기반 논블로킹 흐름으로 처리하기 위해서입니다.
...
> 백엔드 도메인 규칙과 계산 흐름은 [Futures Paper Trading 백엔드 도메인 규칙 PDF](https://raw.githubusercontent.com/lee-gimoon/futures-paper-trading/main/docs/portfolio/futures-paper-trading-backend-domain-rules.pdf)에서 확인할 수 있다.
