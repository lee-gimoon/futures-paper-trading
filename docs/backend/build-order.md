...
- **변경 파일**:
  ...
  - [`paper-trading.md`](paper-trading.md) — 리포지토리 메서드명·컨트롤러 엔드포인트 표를 위 변경에 맞춰 동기화.
...
- **변경 파일**:
  ...
  - [`paper-trading.md`](paper-trading.md) — 현재 상태·엔드포인트 표 동기화.
...
- **변경 파일**:
  ...
  - [`paper-trading.md`](paper-trading.md) — 파일별 역할 표에 `PaperOrderService` 행 추가.
...
- **변경 파일**:
  ...
  - [`paper-trading.md`](paper-trading.md) — 파일 표·현재 상태 동기화.
