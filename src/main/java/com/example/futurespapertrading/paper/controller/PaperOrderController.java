...
// 모의 주문 HTTP 입구. 엔드포인트 3개 — POST(시장가·지정가 주문 생성, C·E단계) / GET(내 주문 목록, D단계) / DELETE(주문 취소, F단계).
...
public class PaperOrderController {
    ...
    // DELETE /api/paper/orders/{id} — 주문 취소 (F단계). 성공 시 200 + status=CANCELED인 OrderResponse.
